	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$encoded(_user$project$Main$EncodedAuth),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$PostDeploy = function (a) {
	return {ctor: 'PostDeploy', _0: a};
};
var _user$project$Main$postDeploy = function (basicAuth) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$PostDeploy,
		_elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"PasswordChange":["String"],"UpdateProgress":["Result.Result Http.Error String"],"EmailChange":["String"],"EncodedAuth":["String"],"PostDeploy":["Result.Result Http.Error String"],"CheckProgress":["Time.Time"],"InstallKinto":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Time.Time":{"args":[],"type":"Float"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
